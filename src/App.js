...
const member = [
  ["さぬQNちゃん"         , "https://data.zqn.wtf/voting/images-mini/5.jpg" , 5],
  ["うどんさん"           , "https://data.zqn.wtf/voting/images-mini/6.jpg" , 6],
  ["Scam Practice Bot"  , "https://data.zqn.wtf/voting/images-mini/7.jpg" , 7],
  ["照れQNちゃん"         , "https://data.zqn.wtf/voting/images-mini/8.jpg" , 8],
  ["ジト目ちゃん"         , "https://data.zqn.wtf/voting/images-mini/9.jpg" , 9],
  ["ZQNちゃん"           , "https://data.zqn.wtf/voting/images-mini/10.jpg" , 10],
  ["白湯P"              , "https://data.zqn.wtf/voting/images-mini/11.jpg" , 11],
  ["姉QNちゃん"          , "https://data.zqn.wtf/voting/images-mini/12.jpg" , 12],
  ["ピクQNちゃん"         , "https://data.zqn.wtf/voting/images-mini/13.jpg" , 13],
]
...
export const StyledImgSquare = styled.img`
  box-shadow: 0px 5px 11px 2px rgba(0, 0, 0, 0.7);
  border: 4px dashed var(--secondary);
  background-color: var(--accent);
  width: 200px;
...
function App() {
  ...
  const claimNFTs = () => {
    ...
    blockchain.smartContract.methods
      .mint(mintAmount,allowlistMaxMintAmount,hexProof,member[mintTokenId][2])
      .send({
  ...
  const decrementMintTokenId = () => {
    let newMintTokenId = mintTokenId - 1;
    if (newMintTokenId < 0) {
      newMintTokenId = 0;
    }
    setMintTokenId(newMintTokenId);
  }
  const incrementMintTokenId = () => {
    let newMintTokenId = mintTokenId + 1;
    if ( member.length -1 < newMintTokenId ) {
      newMintTokenId = member.length -1 ;
    }
    setMintTokenId(newMintTokenId);
  }
                ...
                blockchain.smartContract === null ? (
                  ...
                  <>
                    ...
                    <s.Container ai={"center"} jc={"center"} fd={"row"}>
                      <StyledImgSquare alt={"example"} src={member[mintTokenId][1]} />
                    </s.Container>
                    <s.SpacerMedium />
